...
BLOG_AUTHOR = "Ethan Phan"  # (translatable)
BLOG_TITLE = "Ethan's (sort of) Data Science Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ethanphan.github.io/datascienceblog/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "longfet53@gmail.com"
BLOG_DESCRIPTION = "A blog about data science and AI stuff"  # (translatable)
EXTRA_HEAD_DATA = """
